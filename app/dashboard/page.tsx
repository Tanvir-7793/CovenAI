...
import { FileText, Activity, Menu, X, Home, FileSignature, LogOut, Search, Plus,ScanIcon, Calculator, DollarSign, Calendar, Scan, Scale } from 'lucide-react';
                            ...
                            {doc.cloudinaryUrl && (
                              <div className="ml-4 flex-shrink-0">
                                <a 
                                  ...
                                  className="inline-flex items-center px-3 py-1 border border-blue-200 text-xs font-medium rounded-full text-blue-600 bg-blue-50 hover:bg-blue-100 transition-colors"
                                >
                      ...
                      <div key={doc.id} className="px-6 py-4 hover:bg-gray-50 transition-colors">
                        <div className="flex items-start">
                          <div className="flex-shrink-0 h-10 w-10 rounded-full bg-green-50 flex items-center justify-center mr-3">
                            <ScanIcon className="h-5 w-5 text-green-500" />
                          </div>
                          <div className="flex-1 min-w-0">
